...
export const BODY_PART_FRAMING: Record<BodyPart, string> = {
  head: "Show only the head and face, framed from the neck up, on a solid black background. On top of the finished illustration, overlay simple cartoon doodle-style facial features as if someone drew them with a black marker: big expressive eyes and a fun mouth (grinning, surprised, or silly). Keep these doodles as a separate layer that sits on top of the artwork without replacing the chosen style. The bottom edge must be a clean straight horizontal cut at the neck. At the very bottom of the image draw two small vertical tick marks spaced apart to show the width of the neck, so the next section can align.",
  body: "Show only the torso and arms, framed from the neck to the waist, on a solid black background. On top of the finished illustration, overlay simple cartoon doodle-style details as if drawn with a black marker: silly buttons, doodled pockets, or fun hand gestures. Keep these doodles as a separate layer that sits on top of the artwork without replacing the chosen style. Both the top and bottom edges must be clean straight horizontal cuts. At the very top of the image draw two small vertical tick marks matching the neck width, and at the very bottom draw two small vertical tick marks spaced apart to show the waist width, so adjacent sections can align.",
  legs: "Show only the legs and feet, framed from the waist down, on a solid black background. On top of the finished illustration, overlay simple cartoon doodle-style details as if drawn with a black marker: silly shoes, doodled knee patches, or fun motion lines. Keep these doodles as a separate layer that sits on top of the artwork without replacing the chosen style. The top edge must be a clean straight horizontal cut at the waist. At the very top of the image draw two small vertical tick marks matching the waist width, so this section aligns with the body above.",
};
